#!/usr/bin/env python
"""Development Server Startup Script for Marketing Intelligence"""
import os
import sys
import socket
import random
...
def find_free_port(start=5104, end=5199):
...
def load_demo_data():
    ...
    with app.app_context():
        if Organization.query.count() == 0:
            ...
            org_id = load_demo_data_to_db(db, models, "Acme Marketing Corp")
...
def main():
    ...
    print("=" * 60)
    print("  Marketing Intelligence - Development Server")
    print("=" * 60)

    # Use assigned port (5104)
    port = 5104
    print(f"\n🔌 Using port: {port}")
